...
class Player extends StatefulWidget {
  ...
  final color;
  final autoplay;
  const Player({this.src,this.text,this.color,this.autoplay});
  @override
  PlayerrState createState() =>  PlayerrState();
}

class PlayerrState extends State<Player>{
  bool playing = false;
  String lastSrc = '';
  var color;
  ...
  Future play(url) async {
    ...
    audioPlayer?.play(UrlSource(ans));
      // if (result == 1) {
      //   // success
      //   print(url);
      //   print('play success');
